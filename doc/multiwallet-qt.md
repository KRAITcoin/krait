...
In order to support loading of multiple wallets in krait-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is krait.cpp.
...
Changes to krait.cpp
----------------------
krait.cpp is the entry point into krait-qt, and as such, will require some minor modifications to provide hooks for

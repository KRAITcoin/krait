...
RESOURCES += src/qt/krait.qrc src/qt/krait_locale.qrc

TRANSLATIONS += src/qt/locale/krait_bg.ts \
                src/qt/locale/krait_de.ts \
                src/qt/locale/krait_en.ts \
                src/qt/locale/krait_es.ts \
                src/qt/locale/krait_fi.ts \
                src/qt/locale/krait_fr.ts \
                src/qt/locale/krait_it.ts \
                src/qt/locale/krait_ja.ts \
                src/qt/locale/krait_pl.ts \
                src/qt/locale/krait_pt.ts \
                src/qt/locale/krait_ru.ts \
                src/qt/locale/krait_sk.ts \
                src/qt/locale/krait_sv.ts \
                src/qt/locale/krait_vi.ts \
                src/qt/locale/krait_zh_CN.ts \
                src/qt/locale/krait_zh_TW.ts

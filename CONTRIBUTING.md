Contributing to Krait Core
============================

The Krait Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Krait Core project, and is not to be
confused with overall Krait Network Protocol consensus changes.

Whether a pull request is merged into Krait Core rests with the project merge
...
Patches that change Krait consensus rules are considerably more involved than
...
Where a patch set proposes to change the Krait consensus, it must have been
...
The project leader is the release manager for each Krait Core release.

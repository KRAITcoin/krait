...
/** 
    ...
    ****Note - for Krait we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of krait coming in to a transaction

...
public:
    ...
    void setZKRAITControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzKRAIT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzKRAIT_clicked();
    void on_pushButtonZKRAITControl_clicked();

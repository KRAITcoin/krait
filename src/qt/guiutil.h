...
/** Utility functions used by the Krait Qt UI.
 */
namespace GUIUtil
{
...
// Render Krait addresses in monospace font
...
// Parse "krait:" URI into recipient object, return true on successful parsing

                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received KRAIT from zKRAIT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zKRAIT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zKRAIT));

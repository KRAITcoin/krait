                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Krait Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Krait address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and krait: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKRAIT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Krait Core"), this);
    aboutAction->setStatusTip(tr("Show information about Krait Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Krait"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Krait addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Krait addresses"));
    ...
    openAction->setStatusTip(tr("Open a Krait: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Krait Core help message to get a list with possible Krait command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Krait Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Krait network", "", count));
}
...
{
    QString strTitle = tr("Krait Core"); // default title
